...
namespace GorusmeKayitlari.Components
{
    public class CheckedComboBox : ComboBox
    {
        ...
        internal class Dropdown : Form
        {
            ...
            /// <summary>
            /// Combobox'ta hiçbir item seçilmeyince görüntülenecek yazý.
            /// </summary>
            public string HicbirItemSecilmediYazisi { get; set; }
            ...
            public string GetCheckedItemsStringValue()
            {
                ...
                {
                    sb.Append(this.HicbirItemSecilmediYazisi == null ? string.Empty : this.HicbirItemSecilmediYazisi);
                }
                return sb.ToString();
            }
        ...
        [Description("Combobox'ta hiçbir item seçilmeyince görüntülenecek yazý.")]
        public string HicbirItemSecilmediYazisi { get { return dropdown.HicbirItemSecilmediYazisi; } set { dropdown.HicbirItemSecilmediYazisi = value; } }
